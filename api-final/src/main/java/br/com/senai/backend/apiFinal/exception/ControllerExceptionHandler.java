...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmailException(EmailException ex) {
		...
		ErroResposta erroResposta = new ErroResposta(HttpStatus.UNPROCESSABLE_ENTITY.value(), "Existe campo inválido !",
	...
	public ResponseEntity<Object> handleHttpClientErrorException(HttpClientErrorException ex) {
		...
		ErroResposta erroResposta = new ErroResposta(HttpStatus.NOT_FOUND.value(), "Existe campo inválido !",
				LocalDateTime.now(), erros);
